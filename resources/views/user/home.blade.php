        ...
        <div class="container product1">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div id="myCarousel" class="carousel carousel2 slide" data-ride="carousel" data-interval="0">
                        <div class="carousel-inner">
                        ...
                        <!-- Carousel controls -->
                        <a class="carousel-control carousel-control2 left1 carousel-control-prev" href="#myCarousel"
                           data-slide="prev">
                            <i class="fa fa-angle-left"></i>
                        </a>
                        <a class="carousel-control carousel-control2 right1 carousel-control-next" href="#myCarousel"
                           data-slide="next">
        ...
        <div class="container product2">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div id="myCarousel2" class="carousel carousel3 slide" data-ride="carousel" data-interval="0">
                        <div class="carousel-inner">
                        ...
                        <!-- Carousel controls -->
                        <a class="carousel-control carousel-control3 left2 carousel-control-prev" href="#myCarousel2"
                           data-slide="prev">
                            <i class="fa n fa-angle-left"></i>
                        </a>
                        <a class="carousel-control carousel-control3 right2 carousel-control-next" href="#myCarousel2"
                           data-slide="next">
